...
class QspatiaLiteDialog(QtGui.QDialog):
    def __init__(self, callbackFunction,  callbackFunction1,  callbackFunction2, callbackFunction3, parent=None):
...
"tableprefix_metadata","tableprefix_rasters" ,"sqlite_stat1","sqlite_stat2"]
