...
class QspatiaLite:
    ...
    def run(self):
        ...
        dlg = QspatiaLiteDialog(self.load_to_canvas,self.get_layer_names,self.save_layer,self.delete_tmpshp, self.iface.mainWindow())
        # show the dialog
        dlg.show()
        result = dlg.exec_()
...
# Return list of names of all layers in QgsMapLayerRegistry
    ...
    def save_layer(self, layer, table_name, charset, srid, selected=False, virtualshp=False):
	#use virtual shape
	if virtualshp==True:
