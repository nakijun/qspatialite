...
class QspatiaLiteDialog(QtGui.QDialog):
    def __init__(self, callbackFunction,  callbackFunction1,  callbackFunction2, callbackFunction3, callbackFunction4,callbackFunction5, parent=None):
...
#Methodes
	...
	SQL_List, params_List=self.import_gis_files(self.fileList,srid)
