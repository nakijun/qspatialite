...
# Return list of names of all layers in QgsMapLayerRegistry
	...
	fields=[""" "%s" %s """%(unicode(name.name()).encode('utf-8').replace("'"," ").replace('"'," "),unicode(name.typeName()).encode('utf-8')) for id,name in provider.fields().iteritems()]#Fields with typeName
	feat = QgsFeature()
